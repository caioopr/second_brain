...
const defaults = {
  ...
  async highlighter(code, lang, theme, highlights) {
    if (process.browser && window.sessionStorage.getItem("mdc-shiki-highlighter") === "browser") {
      return import('../nitro/node-server.mjs').then(function (n) { return n.Q; }).then(({ useShikiHighlighter }) => {
...
const rehypePlugins = {
  'highlight': { instance: rehypeShiki, options: {"src":"/home/caio/Documents/Projetos/second_brain/node_modules/@nuxtjs/mdc/dist/runtime/shiki/index.mjs"} },
};

const highlight = {"theme":{"default":"min-light","dark":"min-dark"}};
