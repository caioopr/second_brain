import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-HWEU_oLI.mjs';
import { d as useState, b as useRuntimeConfig } from '../server.mjs';
import { y as hash } from '../../nitro/node-server.mjs';
import { u as useContentPreview } from './preview-CpIoKLn9.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-gThV5DsO.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-zkEyEH44.mjs.map
