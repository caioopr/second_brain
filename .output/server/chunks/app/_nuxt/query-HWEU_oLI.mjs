...
import { e as asyncDataDefaults, f as useNuxtApp, c as createError, b as useRuntimeConfig } from '../server.mjs';
import { z as withLeadingSlash, j as joinURL, x as withoutTrailingSlash, A as withBase, y as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-CpIoKLn9.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-gThV5DsO.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-HWEU_oLI.mjs.map
